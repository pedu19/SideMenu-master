...
SHApp.sharedInstance().registerInstall(forApp: "Sidemenu_app", withDebugMode: true) // The app_key registered in the Pointzi Dashboard.
               //Setting boolean parameter 'withDebugMode' as <true> to print log info, or <false> to prevent log info from printing.
